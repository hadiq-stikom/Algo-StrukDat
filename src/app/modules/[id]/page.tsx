...
import Module4Content from '@/components/modules/Module4Content';
import Module5Content from '@/components/modules/Module5Content';
...
import Module12Content from '@/components/modules/Module12Content';
import Module13Content from '@/components/modules/Module13Content';
import Module14Content from '@/components/modules/Module14Content';
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 px-4 py-8 max-w-3xl mx-auto w-full pb-24">
                <div className="bg-white dark:bg-surface rounded-2xl p-6 border border-primary/5 shadow-sm mb-8">
                 ...
                 {id === '12' && <Module12Content />}
                 {id === '13' && <Module13Content />}
                 {id === '14' && <Module14Content />}
